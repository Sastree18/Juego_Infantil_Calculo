...
public class AventuraNivel3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aventura_nivel3);
        ...
        Toast.makeText(this, "Ciudad Champiñón - Nivel 3", Toast.LENGTH_LONG).show();
    ...
    public void NumeroAleatorio() {
        if(puntos <= 19) {
            ...
            Intent intent = new Intent(this, AventuraNivel4Activity.class);
