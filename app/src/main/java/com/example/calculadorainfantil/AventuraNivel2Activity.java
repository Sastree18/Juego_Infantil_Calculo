...
public class AventuraNivel2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aventura_nivel2);
        ...
        Toast.makeText(this, "Sendero Frondoso - Nivel 2", Toast.LENGTH_LONG).show();
    ...
    public void NumeroAleatorio() {
        if(puntos <= 9) {
            ...
            Intent intent = new Intent(this, AventuraNivel3Activity.class);
    ...
    public void BaseDatos() {
        ...
        Cursor consulta = bd.rawQuery("select * from puntuacionesAventura where puntos = (select max(puntos) from puntuacionesAventura)", null);
