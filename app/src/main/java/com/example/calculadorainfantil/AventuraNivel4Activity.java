...
public class AventuraNivel4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aventura_nivel4);
        ...
        Toast.makeText(this, "Pinar Seco - Nivel 4", Toast.LENGTH_LONG).show();
    ...
    public void NumeroAleatorio() {
        if(puntos <= 24) {
            ...
            Intent intent = new Intent(this, AventuraNivel5Activity.class);
