...
public class AventuraNivel6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aventura_nivel6);
        ...
        Toast.makeText(this, "Bosque tenebroso - Nivel 6", Toast.LENGTH_LONG).show();
    ...
    public void NumeroAleatorio() {
        if(puntos <= 39) {
            ...
            Intent intent = new Intent(this, AventuraNivel7Activity.class);
