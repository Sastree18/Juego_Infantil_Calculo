...
public class AventuraNivel1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this,"Playa Naufragio - Nivel 1", Toast.LENGTH_LONG).show();
    ...
    public void NumeroAleatorio() {
        if(puntos <= 4) {
            ...
            Intent intent = new Intent(this, AventuraNivel2Activity.class);
