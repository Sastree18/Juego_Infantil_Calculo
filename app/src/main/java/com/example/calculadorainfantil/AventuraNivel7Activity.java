...
public class AventuraNivel7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aventura_nivel7);
        ...
        Toast.makeText(this, "Mazmorra Profunda - Nivel 7", Toast.LENGTH_LONG).show();
    ...
    public void NumeroAleatorio() {
        if(puntos <= 54) {
            ...
            } else if(numAleatorioUno >= 0 && numAleatorioUno <= 3) {
                resultado = numAleatorioUno + numAleatorioDos;
                ivSigno.setImageResource(R.drawable.suma);
            } else if(numAleatorioUno >= 4 && numAleatorioUno <=6) {
                resultado = numAleatorioUno - numAleatorioDos;
            ...
            Intent intent = new Intent(this, AventuraFinalActivity.class);
