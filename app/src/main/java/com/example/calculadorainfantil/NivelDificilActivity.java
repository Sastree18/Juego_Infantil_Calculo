...
public class NivelDificilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Mazmorra Profunda - Nivel Dificil", Toast.LENGTH_LONG).show();
    ...
    public void BaseDatos() {
        ...
        bd.insert("puntuacionesPracticaDificil", null, insertar);
        bd.close();
